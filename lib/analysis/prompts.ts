...
export function analysisSystemPrompt(locale: Locale): string {
  return [
    ...
    "For risks, name the clause that creates the risk and explain who it affects. If Indian law is likely to govern the point, set statuteQuery to a short search phrase such as 'security deposit refund tenant' or 'unfair contract term consumer'. Do not cite section numbers or act names in the explanation; the app looks them up separately.",
