  ...
  hi: [
    {
      ...
      paragraphs: [
        "क्लॉज़साथी आपके चिपकाए या अपलोड किए गए समझौते, नोटिस या नीति को पढ़कर सरल भाषा में समझाता है। समझ का हर वाक्य उस धारा की ओर इशारा करता है जिससे वह आया है, ताकि आप खुद जाँच सकें।",
        "यह बताता है कि किसे क्या और कब तक करना है, ध्यान देने योग्य धाराएँ चिह्नित करता है, जहाँ दस्तावेज़ खुद से टकराता है वह दिखाता है, और वकील से मिलने से पहले के प्रश्न और दस्तावेज़ तैयार करता है।",
      ],
    },
    {
      heading: "जनरेटिव AI का उपयोग कैसे होता है",
      paragraphs: [
        "एक Gemini मॉडल समझ को एक संरचित रूप में देता है जिसे ऐप दिखाने से पहले जाँचता है। मॉडल केवल मौजूद धारा पहचान ही उद्धृत कर सकता है; उसकी गढ़ी हुई कोई भी हवाला हटा दी जाती है और स्क्रीन पर गिनी जाती है।",
